...
# Dashboard Overview
![alt text](images/Hospital_Emergency_Room_Analysis_Dashboard.png)
![alt text](images/Daily_Emergency_Room_Patient.png)
![alt text](images/average_waiting_time.png)
